              ...
              {navItems.map((item, idx) => {
                ...
                return (
                  ...
                  >
                    ...
                    <span className="absolute bottom-14 left-1/2 -translate-x-1/2 px-2 py-0.5 bg-zinc-950/90 text-white dark:bg-white/95 dark:text-zinc-900 text-[9px] font-bold rounded border border-zinc-800 dark:border-zinc-200 opacity-0 group-hover:opacity-100 pointer-events-none transition-all duration-200 whitespace-nowrap shadow-md translate-y-1 group-hover:translate-y-0 z-50">
                      {item.title}
                    </span>
            ...
            <div className="shrink-0 flex items-center">
              {user ? (
                <div className="relative group/user">
                  <span className="absolute bottom-14 left-1/2 -translate-x-1/2 px-2 py-0.5 bg-zinc-950/90 text-white dark:bg-white/95 dark:text-zinc-900 text-[9px] font-bold rounded border border-zinc-800 dark:border-zinc-200 opacity-0 group-hover/user:opacity-100 pointer-events-none transition-all duration-200 whitespace-nowrap shadow-md translate-y-1 group-hover/user:translate-y-0 z-50">
                ...
                <Link
                  href="/login"
                  className="w-7 h-7 rounded-full bg-primary text-white flex items-center justify-center text-[10px] font-bold hover:scale-105 active:scale-95 transition-all shadow-md"
                  title="Đăng nhập"
                >
                  IN
                </Link>
