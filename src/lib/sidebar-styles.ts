export const SIDEBAR_STYLES = {
  ...
  linkActive: 'bg-active-bg font-medium text-foreground',
  linkInactive: 'text-secondary hover:text-foreground hover:bg-hover-bg',
  
  // Font chữ cho liên kết phụ (Đồng bộ về 12px)
  nestedLinkText: 'text-[12px] tracking-tight',
  nestedLinkActive: 'bg-active-bg font-medium text-foreground',
  // Nhạt hơn so với liên kết chính (text-secondary/70)
  nestedLinkInactive: 'text-secondary/70 hover:text-foreground hover:bg-hover-bg',
