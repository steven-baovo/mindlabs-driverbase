...
export default function PomodoroPage() {
  return (
    <main className="flex-1 flex flex-col items-center justify-center bg-background px-4 sm:px-6 py-10 sm:py-20 min-h-screen relative overflow-y-auto no-scrollbar">
      ...
      <div className="w-full max-w-3xl flex flex-col gap-8 sm:gap-12 relative z-10">
        ...
        <div className="mt-4 sm:mt-8 border-t border-border-main pt-10 sm:pt-12">
          <FocusTasks />
        </div>
      </div>

      {/* Footer Hint */}
      <div className="mt-16 sm:mt-20 text-[8px] sm:text-[10px] font-black uppercase tracking-[0.4em] text-secondary/20 text-center">
