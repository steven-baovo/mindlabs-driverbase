...
export default function FloatingDock({ user }: FloatingDockProps) {
  ...
  if (isCustomLayout) {
    return (
      <div 
        className="fixed bottom-[4px] left-[4px] z-[9999] pointer-events-auto h-[44px] bg-white border border-border-default rounded-default flex items-center px-4 justify-between"
